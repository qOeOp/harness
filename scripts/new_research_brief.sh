...
template_path="$repo_root/skills/research/templates/research-brief.md"
artifact_label="research brief"
artifact_suffix="research-brief"
...
render_template() {
  ...
  awk \
    ...
    '
      ...
      /^- Question:$/ { $0 = "- Question: " artifact_title }
      { print }
    ' \
    "$template_path"
}
