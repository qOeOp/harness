...
description: 负责 `agents + skills` canonical surface，以及 hooks、commands、MCP 等 adapter 边界。适合在需要设计工具链和工作流时使用。
...
- [../../roles/workflow-automation-lead.md](/Users/vx/WebstormProjects/harness/roles/workflow-automation-lead.md)
